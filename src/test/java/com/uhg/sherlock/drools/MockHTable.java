...
public class MockHTable implements HTableInterface {
  ...
  @Override
  public boolean checkAndPut(byte[] bytes, byte[] bytes1, byte[] bytes2, CompareOp compareOp, byte[] bytes3, Put put) throws IOException {
  ...
  @Override
  public boolean checkAndDelete(byte[] bytes, byte[] bytes1, byte[] bytes2, CompareOp compareOp, byte[] bytes3, Delete delete) throws IOException {
    throw new RuntimeException(this.getClass() + " does NOT implement this method.");
  }
